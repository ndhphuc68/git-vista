  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Header */}
          <div className="flex items-center justify-between px-5 py-4 border-b border-border-subtle bg-surface-hover/30 shrink-0">
          ...
          {/* Form Content */}
          <form onSubmit={handleSubmit} className="p-5 flex flex-col gap-4 overflow-y-auto min-h-0">
            {error && (
