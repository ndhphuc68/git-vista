...
export interface Commands {
  ...
  get_github_repo_info: (repoPath: string) => Promise<GitHubRepoInfo>;
  get_github_token: () => Promise<string | null>;
  save_github_token: (token: string) => Promise<void>;
  remove_github_token: () => Promise<void>;
  checkout_pull_request: (repoPath: string, prNumber: number) => Promise<CheckoutPrResult>;
}
