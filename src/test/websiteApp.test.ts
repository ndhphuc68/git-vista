...
describe('Website app.js logic', () => {
  ...
  it('should successfully execute detectPlatform on mock user agents', () => {
    ...
    expect(fakeWindow.GitVistaWeb.detectPlatform('Mozilla/5.0 (Windows NT 10.0; Win64; x64)')).toBe('windows');
    expect(fakeWindow.GitVistaWeb.detectPlatform('Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7)')).toBe('mac');
