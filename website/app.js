...
(function (window, document, navigator, localStorage) {
  ...
  const ICONS = {
    ...
    linux:
      '<path d="M12.003 2c-3.15 0-5.71 2.56-5.71 5.71 0 1.25.4 2.41 1.08 3.35C5.073 12.18 3.5 14.54 3.5 17.29c0 2.6 2.09 4.71 4.69 4.71h7.62c2.6 0 4.69-2.11 4.69-4.71 0-2.75-1.57-5.11-3.87-6.23.68-.94 1.08-2.1 1.08-3.35 0-3.15-2.56-5.71-5.71-5.71z"/>',
  };

  const DOWNLOAD_URLS = {
    windows:
      "https://github.com/ndhphuc68/git-vista-/releases/latest/download/GitVista_0.1.0_x64-setup.exe",
    mac: "https://github.com/ndhphuc68/git-vista-/releases/latest/download/GitVista_0.1.0_universal.dmg",
    linux:
      "https://github.com/ndhphuc68/git-vista-/releases/latest/download/gitvista_0.1.0_amd64.deb",
  };
  ...
  function updatePrimaryDownloadButton() {
    ...
    if (currentPlatform === "mac") {
      textEl.textContent =
        currentLang === "vi" ? "Tải về cho macOS (.dmg)" : "Download for macOS (.dmg)";
    } else if (currentPlatform === "linux") {
      textEl.textContent =
        currentLang === "vi" ? "Tải về cho Linux (.deb)" : "Download for Linux (.deb)";
    } else {
