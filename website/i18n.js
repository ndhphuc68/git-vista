...
(function (root) {
  const I18N_DATA = {
    en: {
      ...
      "hero.tagline":
        "Built with Rust and modern Web technologies for clarity, speed, and absolute safety.",
      "hero.desc":
        "GitVista turns complex Git operations into intuitive visual workflows. Featuring a topology-based commit graph, zero-latency multi-repository tabs, visual interactive rebase, and a 10-second instant undo safety net so you never lose code again.",
      ...
      "features.subtitle":
        "Powerful desktop tools crafted to streamline everyday development without intimidating Git intricacies.",

      // 6 Core Features
      "features.graph.title": "Interactive Commit Graph",
      "features.graph.desc":
        "Crystal-clear topology-based branch visualization. Virtualized rendering effortlessly handles tens of thousands of commits with 0ms lag.",
      "features.rebase.title": "Visual Interactive Rebase",
      "features.rebase.desc":
        "Drag-and-drop commit reordering with full Pick, Reword, Squash, Fixup, and Drop support. Includes live timeline preview and auto-stash.",
      "features.undo.title": "10s Instant Undo & Safety Refs",
      "features.undo.desc":
        "Never fear losing work. Risky actions automatically create safety backup refs, and an interactive 10-second countdown toast lets you reverse mistakes in one click.",
      "features.multitab.title": "Multi-Tab & Multi-Repo Workspace",
      "features.multitab.desc":
        "Open and inspect multiple repositories side-by-side in a single window with partitioned cache and instant zero-latency tab switching.",
      "features.diff.title": "Word-Level Diff & File Inspector",
      "features.diff.desc":
        "Character and word-level difference highlighting with whitespace ignore toggle, alongside a slide-over drawer featuring line-by-line Git Blame and file history.",
      "features.conflict.title": "3-Way Conflict Resolver & PR Hub",
      "features.conflict.desc":
        "Resolve merge conflicts visually with Ours vs Theirs vs Result hunks. Connect directly with GitHub to browse, inspect, and checkout Pull Requests.",

      // Downloads
      "downloads.badge": "Get Started",
      "downloads.title": "Download GitVista for Your Platform",
      "downloads.subtitle":
        "Choose the installer package tailored for your operating system. Free and open source.",
      ...
      "shortcuts.subtitle":
        "Designed from the ground up so you rarely have to take your hands off the keyboard.",
    ...
    vi: {
      ...
      "hero.tagline":
        "Xây dựng trên nền tảng Rust và công nghệ Web hiện đại cho sự rõ ràng, mượt mà và an toàn tuyệt đối.",
      "hero.desc":
        "GitVista biến các thao tác Git phức tạp thành quy trình trực quan, dễ hiểu. Tích hợp đồ hình commit topology chuẩn xác, mở nhiều dự án song song với độ trễ 0ms, Visual Rebase Studio và cơ chế hoàn tác tức thì 10 giây để bạn không bao giờ lo mất code.",
      ...
      "features.subtitle":
        "Bộ công cụ mạnh mẽ được tối ưu hóa cho công việc lập trình hàng ngày mà không làm bạn rối bời bởi các lệnh Git phức tạp.",

      // 6 Core Features
      "features.graph.title": "Đồ Thị Commit Trực Quan",
      "features.graph.desc":
        "Thuật toán phân nhánh topology biểu diễn rõ ràng các nhánh rẽ và nhánh nhập. Cuộn ảo mượt mà xử lý nhẹ nhàng hàng chục nghìn commit mà không giật lag.",
      "features.rebase.title": "Visual Interactive Rebase",
      "features.rebase.desc":
        "Kéo thả sắp xếp thứ tự commit, hỗ trợ đầy đủ Pick, Reword, Squash, Fixup và Drop. Kèm theo timeline xem trước kết quả thời gian thực và tự động stash.",
      "features.undo.title": "Hoàn Tác 10s & Sao Lưu An Toàn",
      "features.undo.desc":
        "Không còn nỗi sợ mất code khi thao tác nhầm. Mọi hành động rủi ro đều tự động tạo điểm cứu hộ, cùng đồng hồ đếm ngược 10 giây giúp hoàn tác chỉ bằng 1 cú nhấp chuột.",
      "features.multitab.title": "Không Gian Đa Tab & Đa Kho Mã Nguồn",
      "features.multitab.desc":
        "Mở và theo dõi song song nhiều repository trong cùng một cửa sổ ứng dụng với bộ nhớ đệm phân vùng riêng và chuyển đổi tab tức thì với độ trễ 0ms.",
      "features.diff.title": "Word-Level Diff & Thanh Tra Tệp Tin",
      "features.diff.desc":
        "Tô màu chi tiết từng từ, từng ký tự bị sửa đổi kèm nút bật tắt bỏ qua khoảng trắng thừa. Bảng trượt Git Blame từng dòng và xem toàn bộ lịch sử tệp tin.",
      "features.conflict.title": "Bộ Giải Quyết Xung Đột 3 Bên & PR Hub",
      "features.conflict.desc":
        "So sánh trực quan Ours vs Theirs vs Result để chọn thay đổi từng khối an toàn. Kết nối trực tiếp GitHub để duyệt, kiểm tra CI và checkout Pull Requests.",

      // Downloads
      "downloads.badge": "Bắt Đầu Ngay",
      "downloads.title": "Tải GitVista Cho Thiết Bị Của Bạn",
      "downloads.subtitle":
        "Lựa chọn gói cài đặt phù hợp với hệ điều hành của bạn. Hoàn toàn miễn phí và mã nguồn mở.",
      "downloads.windows.title": "Windows",
      "downloads.windows.desc": "Windows 10 / 11 (64-bit)",
      ...
      "shortcuts.subtitle":
        "Được thiết kế tỉ mỉ để bạn hiếm khi phải rời tay khỏi bàn phím khi làm việc với Git.",
      "shortcuts.k1.key": "Ctrl + K",
